...
//     <>
//       <ConfirmDialog
//         open={showConfirm} title="Confirm action"
//         description={`You are about to: ${destructiveLabel}. This cannot be undone.`}
//         confirmLabel="Confirm" onConfirm={handleConfirm}
...
//         <DetailPanel
//           report={selectedReport} loading={detailLoading}
//           actionLoading={actionLoading} claimLoading={claimLoading}
//           escalateLoading={escalateLoading} claimError={claimError}
//           history={reportHistory} historyLoading={historyLoading}
//           currentAdminId={currentAdminId}
//           onClose={() => { dispatch(closeReport()); dispatch(clearClaimError()); }}
//           onUpdate={handleUpdate} onClaim={handleClaim}
//           onRelease={handleRelease} onEscalate={handleEscalate}
//         />
//       )}
...
//         {/* ── STATUS TABS — premium pill style ── */}
...
//         {/* ── FILTERS — styled dropdowns + toggle pills ── */}
...
//                 onChange: (v) => dispatch(setFilters({ targetModel: v })),
//                 options: [
...
//                 onChange: (v) => dispatch(setFilters({ reason: v })),
//                 options: [
...
//                 onChange: (v) => dispatch(setFilters({ priority: v })),
//                 options: [
...
//                 onChange: (v) => dispatch(setFilters({ sortOrder: v })),
//                 options: [
...
//               Apply
//             </button>
//             <button onClick={() => dispatch(clearSelectedIds())}
