...
/** Boolean — is the modal open? Avoids subscribing to the full post object */
export const selectIsModalOpen = createSelector(
  selectSelectedPost,
  (post) => post !== null
);

/** Selected post _id only — for components that only need the id */
 ...
 *  FIX: previously every PostTile had to do deleteLoading === post._id inline */
