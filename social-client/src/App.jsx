...
/>
          <div className="flex-1 overflow-hidden flex gap-6 px-4 py-6 items-start">
 <Sidebar
  onCreatePost={() => setShowCreatePost(true)}
...
/>
            <div
  className={`flex-1 min-w-0 h-full overflow-y-auto transition-all duration-300 ${
    sidebarOpen ? "" : "w-full"
  }`}
>
              <Routes>
                <Route path="/"                 element={<ProtectedRoute><Feed showCreatePost={showCreatePost} setShowCreatePost={setShowCreatePost} /></ProtectedRoute>} />
