...
//   name: "messages",
//   initialState: {
//     followingList:        [],   // ← NEW: following users with their conversations
//     conversations:        [],
...
//     // ✅ Unread badhao sirf tab jab conversation active na ho
...
//       state.totalUnread = state.followingList.reduce((s, f) => s + (f.myUnread || 0), 0);
//     },
//     // Conversation update karo followingList mein after first message
...
//       // Update followingList entry with this conversation
//       const item = state.followingList.find(
//         (f) => conv.participants?.some((p) => p._id === f.user?._id)
//       );
