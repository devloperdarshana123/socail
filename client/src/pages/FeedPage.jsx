    ...
    <WavyBackground>
      ...
      <div className="min-h-screen" style={{ background: "transparent" }}>
        <style>{`
          ...
          .fp-search-input:focus-within { box-shadow: 0 0 0 3px rgba(176,138,90,0.25); }
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-56px)] px-4 py-10">
          <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center lg:items-start justify-center gap-10 lg:gap-14">
            ...
            >
              ...
              <h1 className="text-3xl mb-1" style={{ fontWeight: 700, color: "#1e3a5f" }}>
                Erovians AI
              </h1>
              ...
              <div className="w-full text-left">
                <p className="text-xs font-semibold uppercase tracking-widest mb-3" style={{ color: "#B08A5A" }}>
                  Filter by Category
                </p>
                <div className="flex flex-wrap gap-2">
                  {CATEGORIES.map((cat) => {
