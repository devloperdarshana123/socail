...
//  * CreateGroupModal
//  * Props:
//  *  - following: array of users (jaisa Messages.jsx mein `following` hai)
//  *  - onClose: () => void
//  */
...
//       setError("Group banane ke liye kam se kam 1 member select karo.");
//       return;
//     }
//     setError(null);
//     setStep(2);
...
//     if (!groupName.trim()) {
//       setError("Group ka naam likhna zaroori hai.");
//       return;
//     }
//     setError(null);
//     const action = await dispatch(
//       createGroupConversation({ groupName: groupName.trim(), participantIds: selectedIds })
//     );
//     if (action?.payload?._id) {
//       dispatch(setActiveConversation(action.payload._id));
//       onClose?.();
//     } else {
//       setError(action?.payload || "Group banane mein dikkat hui. Try again.");
//     }
//   };
...
//               color: "var(--color-text-primary)", padding: 0, display: "flex",
//             }}>
...
//             </button>
//           )}
//           <p style={{ fontSize: 15, fontWeight: 600, margin: 0, color: "var(--color-text-primary)", flex: 1 }}>
//             {step === 1 ? "New Group — Select Members" : "Group Details"}
//           </p>
//           <button onClick={onClose} style={{
//             background: "none", border: "none", cursor: "pointer",
//             color: "var(--color-text-tertiary)", fontSize: 18, padding: 0,
//           }}>✕</button>
//         </div>
...
//         {error && (
//           <div style={{
//             margin: "10px 16px 0", padding: "8px 10px", fontSize: 12,
//             background: "#FFF0EC", color: "#D85A30", borderRadius: 8,
//           }}>
//             {error}
//           </div>
//         )}
...
//                         fontSize: 10, lineHeight: "18px", cursor: "pointer",
//                       }}>✕</button>
//                       <p style={{
//                         fontSize: 10, margin: "3px 0 0", maxWidth: 44, overflow: "hidden",
//                         textOverflow: "ellipsis", whiteSpace: "nowrap", color: "var(--color-text-secondary)",
//                       }}>
...
//               {filtered.length === 0 && (
//                 <p style={{ textAlign: "center", fontSize: 13, color: "var(--color-text-tertiary)", padding: 24 }}>
//                   No users found
//                 </p>
//               )}
//               {filtered.map((u) => {
...
//                   >
//                     <MiniAvatar name={u.fullName || u.username} userId={uid} src={u.avatar?.url} size={38} />
...
//                       border: isSelected ? "none" : "1.5px solid var(--color-border-tertiary)",
...
//                   background: selectedIds.length < 1 ? "var(--color-background-secondary)" : "#534AB7",
//                   color: selectedIds.length < 1 ? "var(--color-text-tertiary)" : "#fff",
...
//                     <MiniAvatar name={u.fullName || u.username} userId={u._id?.toString()} src={u.avatar?.url} size={42} />
//                     <p style={{ fontSize: 10, margin: "3px 0 0", maxWidth: 42, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: "var(--color-text-secondary)" }}>
//                       {u.fullName || u.username}
//                     </p>
//                   </div>
//                 ))}
...
//                 style={{
//                   width: "100%", padding: "10px 0", borderRadius: 10, border: "none",
//                   background: !groupName.trim() ? "var(--color-background-secondary)" : "#534AB7",
//                   color: !groupName.trim() ? "var(--color-text-tertiary)" : "#fff",
//                   fontSize: 14, fontWeight: 600,
