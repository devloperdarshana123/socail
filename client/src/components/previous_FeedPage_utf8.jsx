...
//           {/* ΓöÇΓöÇ LEFT: AI Search Panel ΓöÇΓöÇ */}
...
//       {/* ΓöÇΓöÇ CHATBOT (floating, bottom) ΓöÇΓöÇ */}
//       <ChatBot />
//     </div>
//   );
// }
...
export default function FeedPage() {
  ...
  return (
    <WavyBackground>
      ...
      >
      {/* Signature styles ΓÇö medallion ring, fade-in, focus states */}
      <style>{`
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-56px)] px-4 py-10">
        <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
          ...
          {/* ΓöÇΓöÇ RIGHT: Map ΓÇö inlaid medallion frame (signature element) ΓöÇΓöÇ */}
          <div className="w-full lg:flex-1 flex items-center justify-center fp-fade-2">
            ...
            >
              ...
              />
              {/* Slow-rotating bronze dashed ring ΓÇö the medallion signature */}
              <div
