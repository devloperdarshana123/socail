...
const userProfileSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      .addCase(uploadAvatar.pending,   (state) => { state.avatarLoading = true;  state.error = null; })
      .addCase(uploadAvatar.fulfilled, (state, action) => { state.avatarLoading = false; state.avatar = action.payload; })
      .addCase(uploadAvatar.rejected,  (state, action) => { state.avatarLoading = false; state.error = action.payload; });

    builder
      .addCase(uploadCoverPhoto.pending,   (state) => { state.coverLoading = true;  state.error = null; })
      .addCase(uploadCoverPhoto.fulfilled, (state, action) => { state.coverLoading = false; state.coverPhoto = action.payload; })
      .addCase(uploadCoverPhoto.rejected,  (state, action) => { state.coverLoading = false; state.error = action.payload; });

    builder.addCase(removeAvatar.fulfilled,    (state) => { state.avatarLoading = false; state.avatar = null; });
    builder.addCase(removeCoverPhoto.fulfilled, (state) => { state.coverLoading = false; state.coverPhoto = null; });
  },
});
