...
//   if (type === "reel" && mediaItems.length !== 1) return setError("Reel mein exactly 1 video honi chahiye.");
//   if (type === "image" && mediaItems.length < 1) return setError("Image post mein kam se kam 1 image zaroor ho.");
//   if (type === "text" && !caption.trim()) return setError("Text post mein caption required hai.");
...
//       media: mediaItems,           // ← Main Change
//     });

//     reset();
//     onClose();
//   } catch (err) {
//     setError(err?.message || "Post share nahi ho saka.");
//   } finally {
//     setSub(false);
//   }
// };
...
//             { tab !== "text" && (
//   <>
//     <ImageVideoUploader onUploadComplete={handleUploadComplete} />
...
//               className="absolute top-0.5 right-0.5 bg-black/60 rounded-full w-4.4 h-4.5 flex items-center justify-center cursor-pointer"
//             >
//               <X size={10} color="#fff" />
//             </button>
//           </div>
